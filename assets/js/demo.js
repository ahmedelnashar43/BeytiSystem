...
$.notify({
	icon: 'icon-bell',
	title: 'Nashar ',
	message: 'Welcome to beyti lab documentation system',
},{
	type: 'secondary',
	placement: {
		from: "bottom",
...
var statisticsChart = new Chart(ctx, {
	...
	data: {
		...
		datasets: [ {
			...
			label: "	Released Batchs",
			borderColor: '#7CFC00',
			pointBackgroundColor: 'rgba(124, 252, 0 , 0)',
			pointRadius: 0,
			backgroundColor: 'rgb(23, 125, 255,0.4)',
			legendColor: '#7CFC00',
			fill: true,
			borderWidth: 2,
